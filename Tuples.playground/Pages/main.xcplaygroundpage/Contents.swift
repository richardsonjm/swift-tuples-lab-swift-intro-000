 ...
 */
var person: (name: String, age: Int) = ("curly", 32)
 ...
 */
var someone: (name: String, age: Int) = ("mo", 27)
 ...
 */
let human: (name: String, age: Int) = ("larry", 32)
...
// No! can't change value in let constants. 
